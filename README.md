...
For experiments that use the Wireless Insite software, please extract the dataset files from **remcom_maps.rar** in the **Generators** folder to form the **remcom_maps** folder. 
